...
const NurseRequestForm = () => {
  ...
  const handleFetchStudentDetails = () => {
    ...
    axios.get(`/students/reg/${registerNumber}`).then((response) => {
      ...
      if (studentDetails) {
        ...
        // Show a confirmation popup if the student does not exist
  ...
  const handleSubmit = (e) => {
    ...
    const requestData = {
      ...
      year,
      patientName,
      patientRegNo: isStudent ? registerNumber : "Not a student",
      department,
      gender,
      date,
      temperature,
  ...
  return (
    <div className="max-w-lg mx-auto mt-8 p-4 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-semibold mb-4">Nurse Request Form</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="isStudent" className=" font-medium mx-2">
      ...
      <ConfirmationModal
        ...
        onConfirm={() => {
          ...
          // Redirect to the register student page when confirmed
          setIsStudent(false);
        }}
      />
      <ToastContainer />
