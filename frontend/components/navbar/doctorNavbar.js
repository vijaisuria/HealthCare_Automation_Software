      ...
      <nav className="bg-stone-900 text-white">
        <div className="container mx-auto px-4 py-2 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="/doctor" className="hover:text-gray-300">
              Home
            </a>
            <a href="/doctor/requests" className="hover:text-gray-300">
              Requests
            </a>
            <a href="/doctor/prescriptions" className="hover:text-gray-300">
              Prescriptions
            </a>
            <a href="/doctor/profile" className="hover:text-gray-300">
              Profile
            </a>
            <button
